...
export const dexfolioPrefix = 'GF';
export const dexfolioScraperApiSymbolPrefix = `_${dexfolioPrefix}_`;
export const dexfolioFearAndGreedIndexDataSourceCryptocurrencies =
  DataSource.MANUAL;
export const dexfolioFearAndGreedIndexDataSourceStocks = DataSource.RAPID_API;
export const dexfolioFearAndGreedIndexSymbol = `${dexfolioScraperApiSymbolPrefix}FEAR_AND_GREED_INDEX`;
export const dexfolioFearAndGreedIndexSymbolCryptocurrencies = `${dexfolioPrefix}_FEAR_AND_GREED_INDEX_CRYPTOCURRENCIES`;
export const dexfolioFearAndGreedIndexSymbolStocks = `${dexfolioPrefix}_FEAR_AND_GREED_INDEX_STOCKS`;
...
export const WALLET_SYNC_QUEUE = 'WALLET_SYNC_QUEUE';
export const WALLET_SYNC_PROCESS_JOB_NAME = 'WALLET_SYNC';
...
export const PROPERTY_API_KEY_dexfolio = 'API_KEY_dexfolio';
...
export const PROPERTY_DATA_SOURCES_dexfolio_DATA_PROVIDER_MAX_REQUESTS =
  'DATA_SOURCES_dexfolio_DATA_PROVIDER_MAX_REQUESTS';
