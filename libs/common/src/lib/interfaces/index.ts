...
import type { DataProviderDexfolioAssetProfileResponse } from './responses/data-provider-dexfolio-asset-profile-response.interface';
import type { DataProviderDexfolioStatusResponse } from './responses/data-provider-dexfolio-status-response.interface';
