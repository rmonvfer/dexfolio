...
const locales = {
  ...
  DATA_IMPORT_AND_EXPORT_TOOLTIP_BASIC: $localize`Switch to dexfolio Premium or dexfolio Open Source easily`,
  DATA_IMPORT_AND_EXPORT_TOOLTIP_OSS: $localize`Switch to dexfolio Premium easily`,
  DATA_IMPORT_AND_EXPORT_TOOLTIP_PREMIUM: $localize`Switch to dexfolio Open Source or dexfolio Basic easily`,
