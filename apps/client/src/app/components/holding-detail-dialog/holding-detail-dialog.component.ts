...
import { CreateOrderDto } from '@dexfolio/common/dtos';
import { DATE_FORMAT, downloadAsFile } from '@dexfolio/common/helper';
import {
  Activity,
  DataProviderInfo,
...
import { GfAccountsTableComponent } from '@dexfolio/ui/accounts-table';
import { GfActivitiesTableComponent } from '@dexfolio/ui/activities-table';
import { GfDataProviderCreditsComponent } from '@dexfolio/ui/data-provider-credits';
import { GfDialogFooterComponent } from '@dexfolio/ui/dialog-footer';
import { GfDialogHeaderComponent } from '@dexfolio/ui/dialog-header';
    ...
    this.dataService
      ...
      .subscribe(
        ({
          ...
          this.reportDataGlitchMail = `mailto:hi@dexfol.io?Subject=dexfolio Data Glitch Report&body=Hello%0D%0DI would like to report a data glitch for%0D%0DSymbol: ${SymbolProfile?.symbol}%0DData Source: ${SymbolProfile?.dataSource}%0D%0DAdditional notes:%0D%0DCan you please take a look?%0D%0DKind regards`;
          this.sectors = {};
  ...
  public onExport() {
    ...
    this.dataService
      ...
      .subscribe((data) => {
        downloadAsFile({
          content: data,
          fileName: `dexfolio-export-${this.SymbolProfile?.symbol}-${format(
