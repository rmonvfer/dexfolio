import { UserDetailDialogParams } from '@dexfolio/client/components/user-detail-dialog/interfaces/interfaces';
import { GfUserDetailDialogComponent } from '@dexfolio/client/components/user-detail-dialog/user-detail-dialog.component';
...
import { DEFAULT_PAGE_SIZE } from '@dexfolio/common/config';
