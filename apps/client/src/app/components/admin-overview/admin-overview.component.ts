import { CacheService } from '@dexfolio/client/services/cache.service';
...
import { getDateFnsLocale } from '@dexfolio/common/helper';
import {
  Coupon,
  InfoItem,
  SystemMessage,
...
export class GfAdminOverviewComponent implements OnInit {
  ...
  public onAddCoupon() {
    const coupons = [
      ...this.coupons,
      {
        code: `${dexfolioPrefix}${this.generateCouponCode(14)}`,
