import { GfInvestmentChartComponent } from '@dexfolio/client/components/investment-chart/investment-chart.component';
import { UserService } from '@dexfolio/client/services/user/user.service';
import { NUMERICAL_PRECISION_THRESHOLD_6_FIGURES } from '@dexfolio/common/config';
...
import { OrderWithAccount } from '@dexfolio/common/types';
import { GfAccountBalancesComponent } from '@dexfolio/ui/account-balances';
...
import { GfHoldingsTableComponent } from '@dexfolio/ui/holdings-table';
  ...
  public onExport() {
    ...
    this.dataService
      ...
      .subscribe((data) => {
        downloadAsFile({
          content: data,
          fileName: `dexfolio-export-${this.name
            .replace(/\s+/g, '-')
            .toLowerCase()}-${format(
