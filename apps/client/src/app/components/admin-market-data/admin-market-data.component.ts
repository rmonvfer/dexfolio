...
import {
  DEFAULT_PAGE_SIZE,
  dexfolioScraperApiSymbolPrefix
...
import { AdminMarketDataItem } from '@dexfolio/common/interfaces/admin-market-data.interface';
import { hasPermission, permissions } from '@dexfolio/common/permissions';
import { GfSymbolPipe } from '@dexfolio/common/pipes';
import { GfActivitiesFilterComponent } from '@dexfolio/ui/activities-filter';
...
export class GfAdminMarketDataComponent implements AfterViewInit, OnInit {
  ...
  public dexfolioScraperApiSymbolPrefix = dexfolioScraperApiSymbolPrefix;
