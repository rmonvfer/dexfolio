...
jest.mock('@dexfolio/api/services/market-data/market-data.service', () => {
  return {
...
jest.mock(
  '@dexfolio/api/services/exchange-rate-data/exchange-rate-data.service',
  () => {
    return {
...
jest.mock('@dexfolio/api/services/property/property.service', () => {
  return {
