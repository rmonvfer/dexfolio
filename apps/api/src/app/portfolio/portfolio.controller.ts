...
} from '@dexfolio/api/helper/object.helper';
import { PerformanceLoggingInterceptor } from '@dexfolio/api/interceptors/performance-logging/performance-logging.interceptor';
import { RedactValuesInResponseInterceptor } from '@dexfolio/api/interceptors/redact-values-in-response/redact-values-in-response.interceptor';
...
import { getIntervalFromDateRange } from '@dexfolio/common/calculation-helper';
import {
...
import {
  ...
  isRestrictedView,
  permissions
} from '@dexfolio/common/permissions';
import type {
  DateRange,
  GroupBy,
  RequestWithUser
