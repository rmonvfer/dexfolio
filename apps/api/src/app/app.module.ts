import { EventsModule } from '@dexfolio/api/events/events.module';
import { BullBoardAuthMiddleware } from '@dexfolio/api/middlewares/bull-board-auth.middleware';
import { HtmlTemplateMiddleware } from '@dexfolio/api/middlewares/html-template.middleware';
import { ConfigurationModule } from '@dexfolio/api/services/configuration/configuration.module';
import { CronModule } from '@dexfolio/api/services/cron/cron.module';
...
import { DexfolioModule } from './endpoints/data-providers/dexfolio/dexfolio.module';
