...
import { Sector } from '@dexfolio/common/interfaces/sector.interface';
import { MarketDataPreset } from '@dexfolio/common/types';
      ...
      select: {
        ...
        analytics: {
          select: {
            activityCount: true,
            country: true,
            dataProviderdexfolioDailyRequests: true,
            updatedAt: true
          }
        },
        createdAt: true,
    ...
    return usersWithAnalytics.map(
      ({ _count, analytics, createdAt, id, provider, role, subscriptions }) => {
        ...
        return {
          ...
          dailyApiRequests: analytics?.dataProviderdexfolioDailyRequests || 0,
