...
function logLogo() {
  Logger.log('    ____             ____      ___');
  Logger.log('   / __ \\___  _  __/ __/___  / (_)___');
  Logger.log('  / / / / _ \\| |/_/ /_/ __ \\/ / / __ \\');
  Logger.log(' / /_/ /  __/>  </ __/ /_/ / / / /_/ /');
  Logger.log(
    `/_____/\\___/_/|_/_/  \\____/_/_/\\____/ ${environment.version}`
  );
  Logger.log('');
}
